...
Supports prompts like “Continue this over: Over 16.3 Bumrah to Maxwell…” or “Summarize the last 3 overs in a hype style”
...
Examples: “Score for the most recent Pakistan vs New Zealand match” or “Who top scored in the latest India vs Australia game?”
...
Ensures accurate statistics while maintaining natural language responses

💻 Interactive Web Interface

Chat-based UI with temperature and Top-K controls
Includes prompt suggestions and chat history
Built with FastAPI backend and a lightweight frontend

🧱 Project Structure

app/ → FastAPI backend, stats engine, and frontend UI

model/ → Transformer training and generation logic

tokenizer/ → SentencePiece tokenizer and training

data/ → Raw Cricsheet data and processed datasets

checkpoints/ → Trained model checkpoints

preprocess_cricsheet.py → Data preprocessing pipeline
...
Match facts handled by deterministic engine

Commentary handled by transformer model

This prevents hallucination while maintaining natural responses
...
Supports common aliases like Pak → Pakistan and NZ → New Zealand
